...
import 'package:flatpak_gen/src/commands/prepare_command.dart';
...
Future<void> main(List<String> args) async {
  final runner = CommandRunner<void>(
    ...
    'Generate Flatpak source manifests for Flutter/Dart applications.\n\n'
        'Usage examples:\n'
        '  flatpak_gen prepare          # generate everything from pubspec.yaml config\n'
        '  flatpak_gen prepare --tag v0.1.14 --commit abc1234  # CI: pin tag/commit\n'
